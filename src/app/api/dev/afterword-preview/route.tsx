...
import { AfterwordBleedPage } from "@/components/pdf/pages/AfterwordBleedPage";
...
function parsePageKey(v: string | null): AfterwordPageKey {
...
/** 例: /api/dev/afterword-preview?page=left&quality=low */
export async function GET(req: Request) {
  ...
  const buffer = await renderToBuffer(
    <Document>
      <AfterwordBleedPage pageKey={pageKey} />
    </Document>,
  );
  ...
  return new NextResponse(Buffer.from(buffer), {
    ...
    headers: {
      ...
      "Content-Disposition": `inline; filename="afterword-${pageKey}-${quality}.pdf"`,
    },
  });
}
