...
/** Validate an already-separated path/query operation ID using the POST contract. */
export function parseSaveOperationId(raw: unknown): SaveOperationIdParse {
...
export function parseSaveOperationIdFromBody(json: unknown): SaveOperationIdParse {
  ...
  return parseSaveOperationId(raw);
}
