...
export const MORI_ASHIATO_LAYOUTS: Record<MoriAshiatoTemplateId, MoriAshiatoLayoutCoords> = {
  chiisana_ashiato: {
    ...
    dateScrapbook: { x: 160, y: 747, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 20, maxLines: 1 },
    title: { x: 160, y: 806, fontSize: 22, lineHeight: 30, fontWeight: 600, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 16, maxLines: 1 },
    body: { x: 160, y: 860, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 18, maxLines: 1 },
    comment: { x: 160, y: 910, fontSize: 20, lineHeight: 28, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 20, maxLines: 2 },
  },
  kyou_no_ashiato: {
    photo: { x: 168, y: 255, width: 496, height: 400, fit: "cover", borderRadiusPx: 8 },
    dateScrapbook: { x: 168, y: 706, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 20, maxLines: 1 },
    title: { x: 168, y: 757, fontSize: 22, lineHeight: 30, fontWeight: 600, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 16, maxLines: 1 },
    body: { x: 168, y: 810, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 18, maxLines: 1 },
    ...
    comment: { x: 310, y: 870, fontSize: 18, lineHeight: 37, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 18, maxLines: 2 },
  },
  odekake_ashiato: {
    photo: { x: 133, y: 227, width: 574, height: 447, fit: "cover", borderRadiusPx: 9 },
  ...
  oishii_ashiato: {
    ...
    dateScrapbook: { x: 155, y: 736, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 20, maxLines: 1 },
    title: { x: 155, y: 787, fontSize: 22, lineHeight: 30, fontWeight: 600, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 16, maxLines: 1 },
    body: { x: 155, y: 840, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 18, maxLines: 1 },
    comment: { x: 155, y: 896, fontSize: 20, lineHeight: 30, fill: "#4a3728", textAnchor: "start", maxCharsPerLine: 22, maxLines: 1 },
  },
  totteoki_no_ashiato: {
