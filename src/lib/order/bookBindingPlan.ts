/**
 * あしあと製本プラン（ページ数は bookReader / 製本PDF 相当の総ページ数）
 */
...
export const BINDING_PRODUCT_DESCRIPTION_JA =
  "この商品は、アプリ内で作成されたあしあとを製本するサービスです。製本に含めるあしあと本文のページ数に応じてプランが自動選択されます。※1回のあしあと投稿を1ページとして数えます。※表紙・カレンダー・振り返り等はページ数に含みません。※ページ数はご注文時の内容で確定します。";
