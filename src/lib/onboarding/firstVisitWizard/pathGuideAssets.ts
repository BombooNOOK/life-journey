...
const PATH_GUIDE_ASSET_VERSION = 5;
...
export const FIRST_VISIT_PATH_GUIDE_ASSETS = {
  ...
  /** 森の案内所「はじめての道しるべ」カード用（背景透過 PNG） */
  youngLeaf: pathGuideAsset("path_guide_young_leaf.png"),
} as const;

export const FIRST_VISIT_PATH_GUIDE_YOUNG_LEAF_SIZE = { widthPx: 795, heightPx: 710 } as const;
