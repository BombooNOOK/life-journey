...
export const GUIDE_OPERATION_TIPS: readonly GuideOperationTip[] = [
  {
    id: "desk-write",
    title: "日記は、どこから書く？",
    body: "ログハウスの室内で「机」をタップします。普段は「今日はどうしますか？」が開き、ひとりで書くか・鑑定士といっしょに書くかを選べます。",
  ...
  },
  {
    ...
    body: "ログハウス右上の「？」を押すと、本棚や机・ポストなどの名前が小さく表示されます。もう一度押すと消えます。",
    link: { href: "/orders", label: "ログハウスで試す" },
  },
  {
    id: "profile",
    title: "プロフィールはいつ選ぶ？",
    body: "日記は、いま選んでいるプロフィールに残ります。プロフィールが複数あるときは、机のあとの書き方選択画面の上部で切り替えられます。1つだけのときは、その確認は出ません。",
  },
  {
    id: "find-diary",
