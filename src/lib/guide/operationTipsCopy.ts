...
export const GUIDE_OPERATION_TIPS: readonly GuideOperationTip[] = [
  {
    id: "desk-write",
    title: "日記は、どこから書く？",
    body: "ログハウスの室内で「日記を書く」をタップします。普段は「今日はどうしますか？」が開き、ひとりで書くか・鑑定士といっしょに書くかを選べます。",
  ...
  },
  {
    ...
    body: "ログハウス右上の「？」を押すと、本棚や「日記を書く」・ポストなどの名前が小さく表示されます。もう一度押すと消えます。",
    link: { href: "/orders", label: "ログハウスで試す" },
  },
  {
    id: "profile",
    title: "プロフィールはいつ選ぶ？",
    body: "日記は、いま選んでいるプロフィールに残ります。プロフィールが複数あるときは、「日記を書く」のあとの書き方選択画面の上部で切り替えられます。1つだけのときは、その確認は出ません。",
  },
  {
    id: "find-diary",
    title: "書いた日記を、あとから探すには？",
    body: "日付で振り返るときは画面下の「カレンダー」。タグやキーワードで探したいときは「日記一覧」の上部にある「日記を探す」を使います。",
    link: { href: "/orders/list", label: "日記一覧を開く" },
  },
  {
    id: "tags",
    title: "タグは、いつ付ける？",
    body: "日記を書くとき（ひとりでも、いっしょに書くときでも）「タグをつける」から付けられます。付けておくと、あとでタグ検索や日記ブックのテーマ絞り込みに使えます。なくても大丈夫です。",
  },
  {
    id: "go-out",
    title: "お庭や案内図へはどう行く？",
