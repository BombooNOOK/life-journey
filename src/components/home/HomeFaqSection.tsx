...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: "あしあとの内容は、他の人に見られたりしませんか？",
    paragraphs: [
      "ご安心ください。Life Journey Diaryには、他の人にあしあとが公開されるタイムラインや共有機能はありません。",
      "あなたがつづったあしあとや写真は、基本的にご本人だけが見返すための記録です。他人の目を気にせず、本音や小さなできごとを残せる、あなただけの「ひみつの隠れ家」のようにお使いください。",
      "なお、あしあとブックをご注文いただく場合は、製本用のPDFデータを作成・印刷手配のために扱いますが、運営側であしあとの内容を読んで添削・確認することはありません。誤字や写真の配置、掲載内容は、必ずご注文前にアプリ内のプレビューでご確認ください。",
    ],
  },
  {
    question: "利用するのに料金はかかりますか？",
    paragraphs: [
      "Life Journey Diaryには、一定期間が過ぎると使えなくなる無料トライアルはありません。基本の森の体験は、期間を気にせず楽しめます。",
      "最初に必要なのは、お名前と生年月日、メールアドレスの登録だけです。クレジットカード情報の入力は不要です。",
      "あしあとを森に残すなど、一部の機能では「どんぐり」を使います。鑑定やこれまでのあしあとを見返すなど、基本の体験はあなたのペースで続けていただけます。",
      "あしあとブックや鑑定書の製本など、手元に残る一冊をご希望の場合は、別途お申し込み・お支払いとなります（必須ではありません）。",
    ],
  },
  {
    question: "三日坊主で、毎日あしあとを残せる自信がないのですが……",
    paragraphs: [
      "毎日残さなくても大丈夫です。",
      "Life Journey Diaryは、書かなかった日が白紙で残る日記帳ではなく、残した日だけが少しずつ積み重なっていく記録です。",
      "1行だけでも、写真だけでも、残したい日だけで大丈夫。あなたのペースで、思い出をそっと残していけます。",
    ],
  },
  {
    question: "製本（あしあとブック）は、絶対に注文しないといけませんか？",
    paragraphs: [
      "いいえ、製本は必須ではありません。",
      "まずはアプリの中で、あしあとを残して楽しんでいただくだけでも大丈夫です。日々の記録が少しずつたまってきて、「この時間を手元に残したいな」と思ったタイミングで、あしあとブックとしてご注文いただけます。",
