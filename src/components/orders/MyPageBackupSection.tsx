...
/** 設定ページ：日記バックアップ */
export function MyPageBackupSection({ activeProfileNickname }: Props) {
  return (
    <section id="backup" className="scroll-mt-24 space-y-3 rounded-xl border border-stone-200 bg-white p-4 shadow-sm sm:p-5">
      <div>
