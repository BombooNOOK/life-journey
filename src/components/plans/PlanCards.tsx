...
export function PlanCards() {
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <article className="flex flex-col rounded-2xl border border-amber-200/80 bg-gradient-to-br from-white to-amber-50/50 p-5 shadow-sm sm:col-span-2 lg:col-span-1">
        <h2 className="text-lg font-semibold text-stone-900">ちょっとだけのおとどけ</h2>
        <p className="mt-1 text-2xl font-bold text-amber-900">どんぐり20こ</p>
        <p className="mt-1 text-sm font-medium text-amber-900/80">100円（予定）</p>
        <p className="mt-3 text-sm leading-relaxed text-stone-700">
          もう少しだけ使いたいときに、手軽に受け取れる予定です。
        </p>
        <p className="mt-2 text-sm font-medium text-stone-700">現在準備中です。</p>
        <div className="mt-5">
          <button
