...
import { SAVE_TRANSITION_OPENING_TEXT, SAVE_TRANSITION_PHASE1_MS } from "@/lib/journal/journalSaveAfterAnimalMessages";
import {
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        {phase === "opening" ? (
          ...
          >
            <div className="h-1.5" style={{ backgroundColor: OPENING_CARD_STYLE.topAccent }} />
        ...
        {animalBeatReady ? (
          <div className={phase === "animal" ? undefined : "hidden"} aria-hidden={phase !== "animal"}>
            <div
              className="overflow-hidden rounded-2xl shadow-[0_14px_44px_rgba(80,62,44,0.14)]"
              style={{
                borderWidth: 1.5,
            ...
            >
              ...
              <div className="flex flex-col px-6 pb-7 pt-7">
                ...
                <p className="mt-3 ml-auto text-sm font-semibold text-stone-700">{animal.name}より</p>
              </div>
            </div>
          </div>
        ) : null}
