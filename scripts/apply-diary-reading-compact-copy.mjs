/**
 * Applies scripts/diary-reading-compact-copy-manifest.json to source files.
 * Run: node scripts/apply-diary-reading-compact-copy.mjs
 */
...
const personalDraft = `${personalDraftHead}export type PersonalDayNumber = 1 | 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9;
...
console.log("Applied compact copy to:");
